...
public class RoomInput implements InputPort {
    ...
    @Autowired
    private MotelValidator motelValidator; // Usamos MotelValidator aquí también

    private final String MENU = "Seleccione una opción:"
            + "\n 1. Registrar una nueva habitación."
            + "\n 2. Buscar habitaciones por motel."
            + "\n 3. Actualizar detalles de una habitación."
            + "\n 4. Salir.";
    ...
    private void registerRoom() {
        try {
            ...
            System.out.println("Ingrese las características de la habitación:");
            ...
            room.setAvailability(true); // Por defecto, la habitación está disponible
    ...
    private void searchRooms() {
        try {
            ...
            roomService.searchRoomsByMotelName(motelName).forEach(room ->
                System.out.println("Habitación encontrada: " + room.getType() + ", Precio: " + room.getPrice())
            );
        } catch (Exception e) {
    ...
    private void updateRoom() {
        try {
            ...
            System.out.println("Ingrese las nuevas características de la habitación:");
            String characteristics = Utils.getReader().nextLine();
